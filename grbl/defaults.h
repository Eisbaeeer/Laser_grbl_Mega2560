...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 44.35
  #define DEFAULT_Y_STEPS_PER_MM 44.35
  #define DEFAULT_Z_STEPS_PER_MM 50.0
  #define DEFAULT_X_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 540.0 // mm/min
  #define DEFAULT_X_ACCELERATION (5000.0*60*60) // 10*60*60 mm/min^2 = 500 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (5000.0*60*60) // 10*60*60 mm/min^2 = 500 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (500.0*60*60) // 10*60*60 mm/min^2 = 500 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 8000.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 8000.0 // mm NOTE: Must be a positive value.
