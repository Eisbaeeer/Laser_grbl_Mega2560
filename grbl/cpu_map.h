...
#define cpu_map_h
  ...
  #define X_STEP_BIT    3 // MEGA2560 Digital Pin 95
  #define Y_STEP_BIT    4 // MEGA2560 Digital Pin 94
  #define Z_STEP_BIT    5 // MEGA2560 Digital Pin 93
  #define STEP_MASK ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

  // Define step direction output pins. NOTE: All direction pins must be on the same port.
  #define DIRECTION_DDR     DDRF
  #define DIRECTION_PORT    PORTF
  #define DIRECTION_PIN     PINF
  #define X_DIRECTION_BIT   0 // MEGA2560 Digital Pin 97
  #define Y_DIRECTION_BIT   1 // MEGA2560 Digital Pin 96
  #define Z_DIRECTION_BIT   2 // MEGA2560 Digital Pin 95
  ...
  #define Y_LIMIT_BIT     2 // MEGA2560 Digital Pin 51
  #define Z_LIMIT_BIT     1 // MEGA2560 Digital Pin 52
  ...
  #define SPINDLE_OCRA_REGISTER   OCR2A // 16-bit Fast PWM mode requires top reset value stored here.    //Eisbaeeer last
